package io.zerows.infix.neo4j.refine;
...
class N4JNode {
    ...
    static List<String> add(final String graph, final JsonArray node, final String alias) {
        ...
        if (!commands.isEmpty()) {
            N4J.LOG.CQL.info(N4JNode.class, "Add Command: {0}", commands.get(0));
        }
        return commands;
    }
    ...
    static List<String> update(final String graph, final JsonArray conditions, final JsonArray data, final String alias) {
        ...
        if (!commands.isEmpty()) {
            N4J.LOG.CQL.info(N4JNode.class, "Update Command: {0}", commands.get(0));
        }
        return commands;
    }
    ...
    static List<String> delete(final String graph, final JsonArray conditions, final String alias) {
        ...
        if (!commands.isEmpty()) {
            N4J.LOG.CQL.info(N4JNode.class, "Delete Command: {0}", commands.get(0));
        }
        return commands;
    }
